...
--
-- Name: poslog_transaction_retailtransaction_lineitem_tender_auth; Type: TABLE; Schema: public; Owner: poslog
--

CREATE TABLE poslog_transaction_retailtransaction_lineitem_tender_auth (
    id integer NOT NULL
);


ALTER TABLE poslog_transaction_retailtransaction_lineitem_tender_auth OWNER TO poslog;

--
-- Name: poslog_transaction_retailtransaction_lineitem_tender_aut_id_seq; Type: SEQUENCE; Schema: public; Owner: poslog
--

CREATE SEQUENCE poslog_transaction_retailtransaction_lineitem_tender_aut_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE poslog_transaction_retailtransaction_lineitem_tender_aut_id_seq OWNER TO poslog;

--
-- Name: poslog_transaction_retailtransaction_lineitem_tender_aut_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: poslog
--

ALTER SEQUENCE poslog_transaction_retailtransaction_lineitem_tender_aut_id_seq OWNED BY poslog_transaction_retailtransaction_lineitem_tender_auth.id;
...
--
-- Name: poslog_transaction_retailtransaction_lineitem_tender_auth id; Type: DEFAULT; Schema: public; Owner: poslog
--

ALTER TABLE ONLY poslog_transaction_retailtransaction_lineitem_tender_auth ALTER COLUMN id SET DEFAULT nextval('poslog_transaction_retailtransaction_lineitem_tender_aut_id_seq'::regclass);
...
--
-- Name: poslog_transaction_retailtransaction_lineitem_tender_auth poslog_transaction_retailtransaction_lineitem_tender_auth_pkey; Type: CONSTRAINT; Schema: public; Owner: poslog
--

ALTER TABLE ONLY poslog_transaction_retailtransaction_lineitem_tender_auth
    ADD CONSTRAINT poslog_transaction_retailtransaction_lineitem_tender_auth_pkey PRIMARY KEY (id);
